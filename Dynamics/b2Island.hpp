...
#include "Contacts/b2Contact.hpp"
#include "Contacts/b2ContactSolver.hpp"
#include "Joints/b2Joint.hpp"
...
inline b2Island::b2Island(int32 bodyCapacity,
...
inline void b2Island::Solve(b2Profile* profile, const b2TimeStep& step, const b2Vec2& gravity, bool allowSleep)
{
    b2Timer timer;
...
inline void b2Island::SolveTOI(const b2TimeStep& subStep, int32 toiIndexA, int32 toiIndexB)
{
...
inline void b2Island::Report(const b2ContactVelocityConstraint* constraints)
{
